...
const Hero = () => {
  return (
    <section className="relative min-h-[700px] md:min-h-[800px] flex items-center overflow-hidden">
      ...
      >
        <div className="absolute inset-0 bg-gradient-to-r from-secondary/100 via-secondary/60 to-transparent" />
      </div>

      <div className="container mx-auto px-4 py-20 relative z-10">
        <div className="max-w-4xl animate-fade-in">
          <h1 className="text-3xl md:text-5xl lg:text-6xl font-bold mb-6 leading-tight">
            <span className="text-background drop-shadow-[0_2px_4px_rgba(0,0,0,0.8)]">
